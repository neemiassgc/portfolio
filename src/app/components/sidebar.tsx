...
export default function Sidebar() {
  ...
  return (
    <Box component="div" className="h-full w-[360px] fixed top-0 left-0 z-50 pt-4 flex flex-col justify-between gap-0">
      <Box>
      ...
      <Box component="div" className="w-full pt-3 px-3 text-center">
        <Box component="p" className="text-2xl italic hover:underline text-center mb-3" sx={{color: hues.text}}>Skills</Box>
        {
